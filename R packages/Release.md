...
1. Valider le nouveau numéro de version
2. Mettre à jour le fichier DESCRIPTION (avec le nouveau numéro de version en developpement)
3. Mettre à jour le fichier NEWS.md :
	- Ajout d'une nouvelle section pour la release (unreleased=> release + develop + ajout de liens (comparer les versions)).
4. Création du nouveau tag de la release github
5. Merge intermédiaire de main et develop
6. Push des 2 branches et du nouveau tag
7. Draft de la nouvelle release dans la partie `Releases` de GitHub
